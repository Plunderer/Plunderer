	...
	void dropwepon ()
    	{
        	...
        	if(enemyMove.wepontype == 1)
        	{
            		...
            		{
                		case 0:
                    		Instantiate(machingun, new Vector3(transform.position.x,
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 1:
                    		Instantiate(Laser,  new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 2:
                    		Instantiate(misa,  new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		default:
                    		break;
        	...
        	else
        	{
            		...
            		{
                		case 1:
                    		Instantiate(shotgun, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                		break;
                		case 2:
                    		Instantiate(EagleEye, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 3:
                    		Instantiate(Pulsemisa, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 4:
                    		Instantiate(BounceRevolver, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 5:
                    		Instantiate(UCrifle, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 6:
                    		Instantiate(burner, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 7:
                    		Instantiate(Gasogre, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 8:
                    		Instantiate(Gato, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 9:
                    		Instantiate(Voltaic, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 10:
                    		Instantiate(sctum, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 11:
                    		Instantiate(rapid, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 12:
                    		Instantiate(next, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 13:
                    		Instantiate(Tetla, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 14:
                    		Instantiate(bazz, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 15:
                    		Instantiate(moa, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 16:
                    		Instantiate(heby, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 17:
                    		Instantiate(roke, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 18:
                    		Instantiate(loki, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 19:
                    		Instantiate(highcanon, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		case 20:
                    		Instantiate(surabure, new Vector3(transform.position.x, 
                    			transform.position.y + 3, transform.position.z), transform.rotation);
                    		break;
                		default:
                    		break;
